package org.soto.chavez.efren.secciones.catalogo_pendiente.catalogos;
                ...
                while ( true ){
                    ...
                    if(AbmEnum.SALIR.equals(abmEnum)){
                        ...
                        switch (abmEnum){
                            ...
                            case VISTA -> lugar.mostrarVista();
                            case GUARDAR_ARCHIVO -> lugar.guardarArchivo();
                            case LEER_ARCHIVO -> lugar.leerArchivo();
                        }
                    }
                }
            }
