...
public class Colonia extends Lugar{
    ...
    private static ManejoArchivos<Colonia> manejoArchivos = new ManejoArchivos<>(Colonia.class);
    ...
    public void leerArchivo() {
        ...
        listColonia = new ArrayList<>(manejoArchivos.getLista());
        System.out.println("Colonias leídas desde archivo.");
    }
    @Override
    public void guardarArchivo() {
        manejoArchivos.setLista(new ArrayList<>(listColonia));
        manejoArchivos.guardarArchivo();
        System.out.println("Colonias guardadas en archivo.");
    }
